...
# Apply over a 15×15 m grid and predict biomass
# NOTE: Grid resolution changed from 10×10 m to 15×15 m (225 m²) to be more
# consistent with the field plot area of 250 m² (8.92 m radius circular plot).
# This addresses reviewer concern that the pixel size should approximate plot size.
